...
try {
  ...
  // ─── vfx: the 24-demo carousel (Task 122 + the rune originals + the laser + the GPU tier) ──
  ...
  // cycle ALL 24 demos via the ▶ arrow; each goes live (particles > 0)
  ...
  console.log(`[smoke] vfx all 24 live: ${vfxAllLive ? 'yes' : 'SOME STATIC'}`)

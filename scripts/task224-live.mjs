 ...
 *     submit, the present ledger, the field log's tail, the v=224 bust);
...
check('source: the deployed forest page mounts the current cache-bust (v=224)',
  index.includes('main.js?v=224'), '')
...
check('source: the gallery card carries the round',
  gallery.includes('forest') && gallery.includes('Task 224') && gallery.includes('216–224'), '')

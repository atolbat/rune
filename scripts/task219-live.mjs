...
check('source: the walker page mounts main.js?v=219', files.index.includes('main.js?v=219'))
...
check('source: the gallery card tells Task 219', files.gallery.includes('Task 219') && files.gallery.includes('216–219'))

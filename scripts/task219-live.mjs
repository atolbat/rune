...
const files = {
  ...
  main: await (await fetch(LIVE + 'main.js?v=223')).text(),
  tier: await (await fetch(LIVE + '../occlusion/tier.js?v=223')).text(),
  shaders: await (await fetch(LIVE + '../occlusion/shaders.js?v=223')).text(),
  dist: await (await fetch(LIVE + '../../dist/rune.esm.js?v=223')).text(),
...
check('source: the walker page mounts the current cache-bust (v=223 — the Task-222 marks)', files.index.includes('main.js?v=223'))
...
check('source: the gallery cards tell the walker + forest tasks',
  files.gallery.includes('Task 219') && files.gallery.includes('Task 220') && files.gallery.includes('Task 221') && files.gallery.includes('Task 222') && files.gallery.includes('Task 223') && files.gallery.includes('216–223'))
check('source: the README rows tell the walker + forest tasks', files.readme.includes('Task 223'))

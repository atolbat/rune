// noise.js — three.quarks' TurbulenceDemo ("Noise"): a cone of particles
// pushed through a simplex-noise flow field (their TurbulenceField /
// Noise behaviors). Our forces.noise — the deterministic 3D simplex
...
export default {
  ...
  make(env) {
    // the jet: 500 particles/second from a cone pointing +X (their demo

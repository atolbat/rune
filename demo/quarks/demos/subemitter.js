// subemitter.js — three.quarks' SubEmitterDemo: a system whose particles
// SPAWN ANOTHER SYSTEM on death. Theirs: AcidBoiling.json — a boiling acid
// pool whose bubbles POP into splashes. Ours: the onRetire hook (Task 122)
// — every bubble's final state lands in the splash system at the death
// site (facade.at + burst), the sub-emitter pattern in two facades.
export default {
  title: 'Sub Emitter',

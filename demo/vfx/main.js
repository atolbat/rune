...
// guard — bump on release): rune.esm.js is at ?v=167 (Task 167: the
// sync-point pass — the getError drain cadence, the drawArrays mode
// mapping — the dist changed, the mark moves), the untouched bundles
// keep their Task 149 marks.
import { createRenderer, capsule, cube, plane, sphere, torusKnot } from '../../dist/rune.esm.js?v=167'
import {

  ...
  make(env) {
    ...
    const sparks = env.addLayer({
      ...
      facade: env.createParticles({
        ...
        spawner: SPARKS_S,
        render: { kind: 'billboard', draw: 'instance', mode: 'stretched', speedFactor: 0.1, lengthFactor: 0 },
      }),
      material: env.materials.bbSprite,
    ...
    const lines = env.addLayer({
      ...
      facade: env.createParticles({
        ...
        spawner: LINES_S,
        render: { kind: 'billboard', draw: 'instance', mode: 'stretched', speedFactor: 0.05, lengthFactor: 0 },
      }),
      material: env.materials.bbSprite,
      pipeline: env.pipelines.alpha,
      texture: () => env.sparkTexture,

  ...
  make(env) {
    ...
    const flame = env.addLayer({
      ...
      facade: env.createParticles({
        ...
        forces: { drag: 2.2 },
        spawner: FLAME_S,
        render: { kind: 'billboard', draw: 'instance', mode: 'stretched', speedFactor: 0.06 },
      }),
    ...
    const smoke = env.addLayer({
      ...
      facade: env.createParticles({
        ...
        spawner: SMOKE_S,
        render: { kind: 'billboard', draw: 'instance', tiles: [2, 2], frameJitter: 4, spin: 0.5 },
      }),
      material: env.materials.bbSprite,
    ...
    const strikeFlash = env.addLayer({
      ...
      facade: env.createParticles({
        ...
        spawner: FLASH_S,
        render: { kind: 'billboard', draw: 'instance', mode: 'oriented', axis: [0, 0, 1] },
      }),
      material: env.materials.bbSprite,
      pipeline: env.pipelines.additive,
    ...
    const strikeSmoke = env.addLayer({
      ...
      facade: env.createParticles({
        ...
        spawner: BURN_S,
        render: { kind: 'billboard', draw: 'instance', tiles: [2, 2], frameJitter: 4, spin: 0.7 },
      }),
      material: env.materials.bbSprite,
      pipeline: env.pipelines.alpha,
      texture: () => env.smokeAtlas,

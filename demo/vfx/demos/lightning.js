  ...
  make(env) {
    ...
    const bolt = env.addLayer({
      ...
      facade: env.createParticles({
        ...
        spawner: BOLT_BASE,
        render: { kind: 'billboard', draw: 'instance', mode: 'stretched', speedFactor: 0.04, lengthFactor: 3.4 },
      }),
    ...
    const afterglow = env.addLayer({
      ...
      facade: env.createParticles({
        ...
        spawner: GLOW_BASE,
        render: { kind: 'billboard', draw: 'instance', mode: 'stretched', speedFactor: 0.02, lengthFactor: 2.2 },
      }),
      material: env.materials.bbSprite,
      pipeline: env.pipelines.additive,
    ...
    const branches = env.addLayer({
      ...
      facade: env.createParticles({
        ...
        spawner: BRANCH_BASE,
        render: { kind: 'billboard', draw: 'instance', mode: 'stretched', speedFactor: 0.04, lengthFactor: 2.6 },
      }),
      material: env.materials.bbSprite,
      pipeline: env.pipelines.additive,
      texture: () => env.ribbonTexture,
    ...
    const flash = env.addLayer({
      ...
      facade: env.createParticles({
        ...
        spawner: FLASH_S,
        render: { kind: 'billboard', draw: 'instance', mode: 'oriented', axis: [0, 0, 1], tiles: [4, 4] },
      }),
      material: env.materials.bbSprite,
      pipeline: env.pipelines.additive,
    ...
    const horizon = env.addLayer({
      ...
      facade: env.createParticles({
        ...
        spawner: HORIZON_S,
        render: { kind: 'billboard', draw: 'instance', mode: 'camera', tiles: [4, 4] },
      }),
      material: env.materials.bbSprite,
      pipeline: env.pipelines.additive,
      texture: () => env.atlasTexture,

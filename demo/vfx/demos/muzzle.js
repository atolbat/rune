  ...
  make(env) {
    ...
    const beam = env.addLayer({
      ...
      facade: env.createParticles({
        ...
        spawner: BEAM_S,
        render: { kind: 'billboard', mode: 'stretched', speedFactor: 0.85, lengthFactor: 0.25 },
      }),
      material: env.materials.sprite,
      pipeline: env.pipelines.additive,
      texture: () => env.muzzleSheet,
    ...
    const sparks = env.addLayer({
      ...
      facade: env.createParticles({
        ...
        spawner: SPARKS_S,
        render: { kind: 'billboard', mode: 'stretched', speedFactor: 0.22 },
      }),
      material: env.materials.sprite,
      pipeline: env.pipelines.additive,
    ...
    const shells = env.addLayer({
      ...
      facade: env.createParticles({
        ...
        spawner: SHELL_S,
        render: { kind: 'billboard', spin: 9, tiles: env.atlasTiles },
      }),
      material: env.materials.sprite,
      pipeline: env.pipelines.alpha,
      texture: () => env.atlasTexture,

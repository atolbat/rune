...
describe('glsl reflect', () => {
  it('collects the union of vertex and fragment uniforms', () => {
  ...
  it('distinguishes types and array lengths', () => {
    const reflection = reflectGlsl(VERTEX, FRAGMENT)
  ...
  it('reads vertex layout(location) attributes', () => {
    const reflection = reflectGlsl(VERTEX, FRAGMENT)
  ...
  it('skips interface uniform blocks', () => {

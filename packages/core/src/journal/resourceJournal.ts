...
export type ResOp =
  ...
  | { readonly kind: 'target.create'; readonly id: number; readonly textureId: number; readonly width: number; readonly height: number; readonly depth: boolean; readonly color: ClearColor2; readonly depthBits?: 16 | 24 | 32; readonly depthTextureId?: number }
